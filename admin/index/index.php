...
if(empty($_SESSION['username'])){
       header("location:http://localhost/admin/index/login.html");exit('请先登录');
}
?>
<!DOCTYPE html>
<html>
			...
			<div class="main-layout-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  ...
				  <li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="user_index.html" data-id='3' data-text="用户管理"><span class="l-line"></span>用户管理</a></dd>
				      <dd><a href="javascript:;" data-url="user_add.html" data-id='9' data-text="添加用户"><span class="l-line"></span>添加用户</a></dd>
				    </dl>
				  </li>
				   <li class="layui-nav-item">
						<a href="javascript:;"><i class="iconfont">&#xe60c;</i>友情链接</a>
						<dl class="layui-nav-child">
								<dd><a href="javascript:;" data-url="flink_index.html" data-id='3' data-text="链接管理"><span class="l-line"></span>链接管理</a></dd>
				  ...
				  <li class="layui-nav-item">
				    ...
				    <dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="http://localhost/admin/php/public/system.php" data-id='0' data-text="系统信息"><span class="l-line"></span>系统信息</a></dd>
 
							<dd><a href="javascript:;" data-url="system.html" data-id='0' data-text="系统设置"><span class="l-line"></span>系统设置</a></dd>
						</dl>
				  </li>
				  <li class="layui-nav-item">
						<a href="javascript:;"><i class="iconfont">&#xe600;</i>备份管理</a>
						<dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="db_backup.html" data-id='0' data-text="备份数据库"><span class="l-line"></span>备份数据库</a></dd>
				      <dd><a href="javascript:;" data-url="db_reduction.html" data-id='9' data-text="还原数据库"><span class="l-line"></span>还原数据库</a></dd>
				    </dl>
				  </li>
				  <li class="layui-nav-item">
